...
export default {
  ...
  methods:{
    ...
    addNew(){
        this.modal = 'new';
        this.reset();
        //this.$refs["product-modal"].modal('show')
        // var accountModal = document.getElementById("product");
        // accountModal.modal('show');
        

        // document.querySelector('#product').modal('toggle');
    ...
    updateProduct(){
        this.$firestore.products.doc(this.product.id).update(this.product);
          window.Toast.fire({
            ...
            //this.$refs['product-modal'].classList.add('hide')
    ...
    editProduct(product){
     ...
     // this.$refs['product-modal'].classList.add('show')
      jQuery('#product').modal('show');
    },
    ...
    addProduct(){
     ...
     //this.$refs['product-modal'].addClass('hide')
      jQuery('#product').modal('hide');
    }
